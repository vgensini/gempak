...
if [ "x$DOAUTOTOOL" = "xTRUE" ]; then
    ...
    if [ "x$DOACTION" = "xbuild" ]; then
        ...
        LIBS="-lhdf5_hl -lhdf5 -ldl -lm -lz " CFLAGS="-I/home/gempak/GEMPAK7/os/linux64/include" LDFLAGS="-L/home/gempak/GEMPAK7/os/linux64/lib" ./configure --prefix=/home/gempak/GEMPAK7/os/linux64 $STATIC_BUILD $SHARED_BUILD
        LIBS="-lhdf5_hl -lhdf5 -ldl -lm -lz " make
        LIBS="-lhdf5_hl -lhdf5 -ldl -lm -lz " make check
    fi
